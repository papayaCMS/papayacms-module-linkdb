...
* @version $Id: output_linkdb.php 39733 2014-04-08 18:10:55Z weinert $
*/
...
class output_linkdb extends base_linkdb {
  ...
  */
  function getXMLLinkNavigation(
    $offset, $step, $max, $paramName, $callCateg, $data
  ) {
    $string = '';
    if (($max > $step)) {
      $string .= '<linksnavi>';
