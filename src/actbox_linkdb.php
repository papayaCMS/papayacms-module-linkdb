...
* @version $Id: actbox_linkdb.php 39512 2014-03-04 15:57:18Z weinert $
*/
  ...
  */
  ...
  function getChildCategs($id, $indent, $selectedId) {
    ...
    if (isset($this->categs[$id]) && is_array($this->categs[$id])) {
      ...
      $selected = ($selectedId == $this->categs[$id]['linkcateg_id'])
        ? ' selected="selected"' : '';
      $result .= sprintf(
      ...
      $result .= $this->getCategSubTree($id, $indent + 1, $selectedId);
    }
    return $result;
  }
